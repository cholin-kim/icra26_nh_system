...
if __name__ == "__main__":
    ...
    quit()
    TCAM_ee1 = np.array(
        [[-0.67015052, 0.50483629, -0.54409429, -0.0341024],
         [0.115617, -0.65310751, -0.74838712, -0.01875679],
         [-0.73316505, -0.56443857, 0.37931268, 0.12258075],
         [0., 0., 0., 1]])

    TCAM_ee2 = np.array(
        [[-0.95108497, 0.25161858, -0.17923579, -0.00465216],
         [0.06221691, -0.41228589, -0.90892761, -0.0020572],
         [-0.30259946, -0.87561889, 0.37646398, 0.11502147],
         [0., 0., 0., 1]])

    joint_pos1 = np.array([0.82081381, -0.04179556, 0.16671462, 2.31382188, 0.16455095, -0.20411074])
    joint_pos2 = np.array([-0.60447734, 0.1436961, 0.19706603, 0.13356349, -0.13214122, 0.21893565])

    Trb1_ee = np.array(
        [[-0.301, 0.635, -0.711, 0.123],
         [-0.69, -0.66, -0.298, 0.011],
         [-0.659, 0.401, 0.637, -0.116],
         [0., 0., 0., 1.]])
    Trb2_ee = np.array(
        [[0.927, 0.103, 0.361, -0.111],
         [-0.126, 0.991, 0.041, -0.026],
         [-0.354, -0.083, 0.932, -0.164],
         [0., 0., 0., 1.]])
    Tcam_rb1 = TCAM_ee1 @ np.linalg.inv(Trb1_ee)
    Tcam_rb2 = TCAM_ee2 @ np.linalg.inv(Trb2_ee)

    Tcam_rb1 = np.array(
        [[ 0.90956944,  0.29071326 , 0.29708341 ,-0.11471561],
         [ 0.08243522,  0.57414903 ,-0.81425316, -0.12966533],
         [-0.40809498,  0.76507203 , 0.49787851 , 0.22211455],
         [ 0.   ,       0.   ,       0.     ,     1.        ]])

    Tcam_rb2 = np.array(
    [[-0.92019312 , 0.3619559  , 0.1481907,  -0.07307947],
     [-0.31301221, -0.45335268 ,-0.83405874, -0.18537436],
     [-0.23454023 ,-0.81475256 , 0.53062002 , 0.15482562],
     [ 0.       ,   0.    ,      0.      ,    1.        ]])


    print(flatten_T(Tcam_rb1))
    print(flatten_T(Tcam_rb2))
    [-0.11471561, - 0.12966533 , 0.22211455 , 0.45743123 , 0.20415083, - 0.06038019  ,   0.86338482]
    [-0.07307947, - 0.18537436 , 0.15482562, - 0.0252886, - 0.48377707 , 0.85212605   ,  - 0.1979935]
