...
# sys.path.append("..")
# sys.path.append("...")
from segment_anything.sam2.build_sam import build_sam2_camera_predictor
...
class SAM:
    def __init__(self, which='L'):
        ...
        # SAM2 로딩
        sam2_checkpoint = "../checkpoints/segment_anything.1_hiera_base_plus.pt"
        model_cfg = "configs/segment_anything.1/segment_anything.1_hiera_b+.yaml"
